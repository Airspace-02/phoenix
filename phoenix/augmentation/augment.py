...
class Builder(AbstractBuilder):
            ...
            "operations":[
                {
                    ...
                    "operation_module" : "phoenix.augmentation",
                    "args": {
                        "probability": 0.7,
                        "darkness" : 0.5,
                        "is_mask" : true,
    ...
    def __init__(self, config_json="config.json"):
        ...
        self.logger = get_logger("Phoenix Builder", level=logging.INFO)
    ...
    def _add_operation(self, pipeline):
        """
            Adds operation to phoenix pipeline. Dynamic module loading.
        """
    ...
    def _load_entities(self, data_sample_list):
        """
            Method to return images, annotations and masks as PhoenixData objects for the given paths
        """
    ...
    def _save_entities_to_disk(self, entities):
        """
            Method to save the PhoenixData objects to the output directory
