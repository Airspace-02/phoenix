...
from phoenix.utils.CustomExceptions import CoefficientNotinRangeError, OperationNotFoundOrImplemented, \
...
err_msgs = [
    ...
    '"XYZ" not found or implemented in the module "phoenix.augmentation"',
